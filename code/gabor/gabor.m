...
destionRect = SetRect(1,1,150,150);
destionRect= CenterRectOnPoint(destionRect,570,575);
...
% for us.
Screen('DrawTextures', window, gabortex, [], destionRect, orientation, [], [], [], [],...
